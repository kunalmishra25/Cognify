                ...
                <div className="relative z-10 p-12 flex flex-col h-full justify-between">
                    ...
                    <div className="mt-10 mb-auto flex-1 flex flex-col justify-center">
                        <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-5">
                            Manage your <br />study files <br />the smart way
                        </h1>
                        <p className="text-indigo-100 text-[15px] leading-relaxed max-w-xs font-light">
                            Awesome, we've created the perfect place for you to store your documents and generate AI study materials.
                        </p>
                    </div>
            ...
            <div className="w-full md:w-7/12 bg-white px-6 py-10 md:p-10 lg:p-12 flex flex-col justify-center relative min-h-screen md:h-full">
                <div className="max-w-md mx-auto w-full">
                    ...
                    <form className="space-y-4" onSubmit={handleLogin}>
                        ...
                        <div className="flex items-center justify-between text-[13px] pt-1">
                            <label className="flex items-center text-gray-600 cursor-pointer hover:text-gray-800">
                                <input type="checkbox" className="w-4 h-4 rounded border-gray-200 text-[#6B82F6] focus:ring-[#6B82F6] mr-2 cursor-pointer transition-all" />
                                Remember me
                            </label>
                            <a href="#" className="font-semibold text-[#6B82F6] hover:text-indigo-700 transition-colors">Forgot password?</a>
                        </div>
                    ...
                    <p className="text-center mt-6 text-[14px] text-gray-500 font-medium">
                        Don't have an account? <Link to="/signup" className="font-semibold text-[#6B82F6] hover:text-indigo-700 transition-colors">Create Account</Link>
                    </p>
                </div>
            </div>
        </div>
