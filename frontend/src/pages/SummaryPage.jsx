...
const SummaryPage = () => {
    ...
    const handledownload = () => {
        ...
        // Extract string content whether summary is a string or an object
        ...
        link.href = url;
        link.download = "Cognify-Summary.txt";

        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);

        // Delay URL revocation so browser download manager can process the blob
        setTimeout(() => {
            ...
            <div className="max-w-4xl mx-auto w-full px-4 sm:px-6 flex-1 flex flex-col">
                ...
                {!summary ? (
                    <div className="text-center bg-white/60 backdrop-blur-xl p-8 sm:p-14 rounded-[2rem] sm:rounded-[2.5rem] border border-white/80 w-full max-w-lg mx-auto shadow-[0_8px_30px_rgb(0,0,0,0.04)] mt-10">
                        ...
                        <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3 tracking-tight">
                            No Summary Found
                        </h3>
                    ...
                    <div className="flex-1 flex flex-col w-full">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            ...
                            <div className="flex items-center gap-2 self-start sm:self-center shrink-0">
                                ...
                                {/* Add Note */}
                                <button
                                    className="p-2.5 bg-white border border-gray-150 hover:bg-gray-50 rounded-xl text-gray-400 hover:text-indigo-500 transition-all cursor-pointer group relative"
                                    title="Add Note"
                                >
                                    <svg
